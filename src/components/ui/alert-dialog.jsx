import React from 'react';
    ...
    const AlertDialogCancel = React.forwardRef(({ className, ...props }, ref) => (
      <AlertDialogPrimitive.Cancel ref={ref} className={cn(buttonVariants({ variant: "outline" }), "mt-2 sm:mt-0 bg-slate-600 hover:bg-slate-500 border-slate-500 text-white", className)} {...props} />
    ));
